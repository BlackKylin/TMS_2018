        ...
        <section class="content container-fluid">
            <div class="col-md-7">
                <form method="post" id="saveFrom">
                    <legend>修改销售点信息</legend>
                    <a href="/manage/pos/home" class="btn btn-success  pull-right  fa fa-plus" >返回</a>

                    <div class="form-group">
                        <label>销售点名称</label>
                        <input type="text" class="form-control" name="posName" value="${pos.posName}">
                    </div>
                    <div class="form-group">
                        <label>销售点地址</label>
                        <input type="text" class="form-control" name="posSite" value="${pos.posSite}">
                    </div>
                    <div class="form-group">
                        <label>经营者</label>
                        <input type="text" class="form-control" name="ownerName" value="${pos.ownerName}">
                    </div>
                    <div class="form-group">
                        <label>联系方式</label>
                        <input type="text" class="form-control" name="posNumber" value="${pos.posNumber}">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
